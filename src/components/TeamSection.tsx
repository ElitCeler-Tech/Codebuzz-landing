...
export default function TeamSection() {
    return (
        <section className="py-12 md:py-24 px-4 bg-white flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-6 md:gap-8 px-4 max-w-7xl w-full mb-8 md:mb-12">
                {teamMembers.map((member, index) => (
                    <div key={index} className="flex flex-col gap-4 group cursor-pointer w-full sm:w-56 md:w-72">
                        {/* Image Placeholder */}
                        <div
