  ...
  return (
    <>
      <nav className="flex items-center justify-between px-4 sm:px-8 py-4 bg-white shadow-sm sticky top-0 z-50">
        <Link
          href="/"
          className="text-xl sm:text-2xl font-bold font-montserrat text-[#ff830a]"
        >
          CodeBuzz
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            ...
            className="font-medium text-[#ff830a] hover:opacity-80 transition-opacity"
          >
            Sign In
          </Link>
          <Link
      ...
      {/* Mobile Menu Drawer */}
      <div
        className={`md:hidden fixed top-0 right-0 h-full w-[280px] bg-white shadow-xl z-50 transform transition-transform duration-300 ease-in-out ${
